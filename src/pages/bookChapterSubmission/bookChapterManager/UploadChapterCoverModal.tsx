...
const UploadChapterCoverModal: React.FC<UploadChapterCoverModalProps> = ({ book, isOpen, onClose, onSave }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1000] p-4 text-[12px]">
            <div className="bg-white rounded-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-3">
                    <div className={`relative flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 overflow-hidden ${previewUrl ? 'h-[300px]' : 'p-4'}`}>
                        {previewUrl ? (
                            <>
                                ...
                                <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur p-2 rounded-lg shadow-lg flex items-center gap-3 z-10">
                                    ...
                                    <button
                                        ...
                                        className="p-1 px-2 text-[10px] bg-red-100 text-red-600 rounded hover:bg-red-200 font-bold"
                                    >
                                        Change
                                    </button>
                                </div>
                            ...
                            <div className="text-center">
                                ...
                                <div className="mt-2 text-[12px] text-gray-600">
                                    <label htmlFor="chapter-cover-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
